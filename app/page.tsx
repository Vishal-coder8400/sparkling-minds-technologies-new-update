  ...
  return (
    <div className="bg-gray-50 min-h-screen">
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-14 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-center">
            ...
            <div className="animate-slide-in-left">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600 text-pretty">
                ...
                We deliver enterprise-grade AI, web development, and cloud
                services that drive innovation and accelerate growth.
              </p>
              <div className="mt-10 flex items-center gap-x-6">
                ...
                <Button
                  ...
                  className="bg-gradient-to-r from-[#0A1B6F] via-[#4E26E2] to-[#B948FF] 
                    ...
                    text-white px-8 py-3 rounded-lg font-semibold shadow-md transition-all transform hover:scale-105"
                >
                  Get started
                </Button>
                {/* Secondary CTA */}
            ...
            <div className="animate-slide-in-right">
              <div className="relative mx-auto w-full max-w-lg">
                <div className="clean-card p-8 transform rotate-3 hover:rotate-1 transition-transform duration-300">
                  <div className="aspect-[4/3] rounded-lg bg-gradient-to-br from-[#0A1B6F]/10 via-[#4E26E2]/10 to-[#B948FF]/10 p-6">
                    <img
      ...
      <section className="bg-gradient-to-b from-gray-50 to-white py-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl text-center">
            <p className="text-sm font-semibold uppercase tracking-wide bg-gradient-to-r from-[#0A1B6F] via-[#4E26E2] to-[#B948FF] bg-clip-text text-transparent">
      ...
      <section className="py-24 sm:py-32 bg-gray-50">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-base font-semibold leading-7 bg-gradient-to-r from-[#0A1B6F] via-[#4E26E2] to-[#B948FF] bg-clip-text text-transparent">
              Our Services
            </h2>
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              ...
              services that transform your business vision into reality.
            </p>
          </div>
              ...
              {[
                ...
                <div key={service.name} className="clean-card p-8 group">
                  <div className="flex items-center gap-x-3 mb-4">
                    ...
                    <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-r from-[#0A1B6F] via-[#4E26E2] to-[#B948FF] group-hover:opacity-90 transition-all">
                  ...
                  <div className="mt-6">
                    <Link
                      href="/services"
                      className="text-sm font-semibold bg-gradient-to-r from-[#0A1B6F] via-[#4E26E2] to-[#B948FF] bg-clip-text text-transparent hover:opacity-80 transition-colors"
                    >
      ...
      {[
        ...
        <div key={index} className="clean-card p-8">
          ...
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-full bg-gradient-to-r from-[#0A1B6F] to-[#B948FF] flex items-center justify-center">
      ...
      <div className="clean-card overflow-hidden">
        ...
        <div className="p-8">
          <div className="flex items-center gap-2 mb-3">
            <span className="inline-flex items-center rounded-full bg-gradient-to-r from-[#0A1B6F] to-[#B948FF] px-3 py-1 text-xs font-medium text-white">
              AI & Automation
            </span>
          </div>
          ...
          <Link
            href="/case-studies"
            className="inline-flex items-center bg-gradient-to-r from-[#0A1B6F] to-[#B948FF] bg-clip-text text-transparent font-semibold"
          >
  ...
  <div className="mx-auto max-w-7xl px-6 lg:px-8">
    ...
    <div className="mx-auto mt-16 grid max-w-2xl grid-cols-2 gap-6 sm:grid-cols-3 lg:mx-0 lg:max-w-none lg:grid-cols-6">
      {[
        ...
        <div
          key={index}
          className="clean-card p-6 text-center group hover:scale-105 transition-transform"
        >
          <div className="h-12 w-12 mx-auto mb-3 bg-gradient-to-r from-[#0A1B6F] to-[#B948FF] rounded-lg flex items-center justify-center group-hover:opacity-90 transition-all">
          ...
          <div className="flex justify-center mb-6">
            <div className="relative">
              ...
              <div className="flex h-16 w-16 items-center justify-center rounded-full 
                bg-gradient-to-r from-[#0A1B6F] via-[#4E26E2] to-[#B948FF] text-white shadow-lg">
                <process.icon className="h-8 w-8" />
              </div>
              <div className="absolute -top-2 -right-2 h-8 w-8 rounded-full 
                bg-gradient-to-r from-[#E0D7FF] to-[#F2EAFF] flex items-center justify-center shadow">
                <span className="text-xs font-bold bg-gradient-to-r from-[#0A1B6F] to-[#B948FF] bg-clip-text text-transparent">
                  {process.step}
                </span>
              </div>
            </div>
...
{/* CTA Section */}
<section className="bg-gradient-to-r from-[#F9F7FF] to-[#F3F0FF] border-t border-gray-200">
  <div className="px-6 py-24 sm:px-6 sm:py-32 lg:px-8">
    <div className="mx-auto max-w-2xl text-center">
      ...
      <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-600">
        Let's discuss how our expertise can help you achieve your technology goals and drive innovation in your industry.
      </p>
      <div className="mt-10 flex items-center justify-center gap-x-6">
        ...
        <Button
          ...
          className="bg-gradient-to-r from-[#0A1B6F] via-[#4E26E2] to-[#B948FF] 
            hover:from-[#1A2CCF] hover:via-[#7231EC] hover:to-[#953DF5]
            text-white px-8 py-3 rounded-lg font-semibold shadow-lg transform hover:scale-105 transition-all duration-300"
        >
        ...
        <Link
          href="/contact"
          className="text-sm font-semibold leading-6 bg-gradient-to-r from-[#0A1B6F] to-[#B948FF] bg-clip-text text-transparent hover:opacity-80 transition"
        >
