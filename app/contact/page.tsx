      ...
      <section className="py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">Choose the best way to reach us based on your needs.</p>
          </div>
              ...
              {contactMethods.map((method) => (
                <Card key={method.name} className="border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
                  <CardHeader className="text-center">
                    <div className="flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-r from-blue-600 to-teal-600 text-white mx-auto mb-4">
                  ...
                  <CardContent className="text-center space-y-2">
                    <div className="flex items-center justify-center text-sm text-gray-600">
                      ...
                      <a href={`mailto:${method.contact}`} className="hover:text-blue-600">
                        {method.contact}
                      </a>
                    </div>
                    <div className="flex items-center justify-center text-sm text-gray-600">
                      <Phone className="h-4 w-4 mr-2" />
                      <a href={`tel:${method.phone}`} className="hover:text-blue-600">
                        {method.phone}
                      </a>
                    </div>
                  </CardContent>
