        ...
        <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl text-balance">
              Our <span className="bg-gradient-to-r from-blue-600 to-teal-600 bg-clip-text text-transparent">Blog</span>
            </h1>
              ...
              <div className="flex flex-wrap gap-2">
                {categories.map((category) => (
                  <Button
                    ...
                    className={selectedCategory === category ? "bg-gradient-to-r from-blue-600 to-teal-600" : ""}
                  >
                    {category}
                  </Button>
                ))}
